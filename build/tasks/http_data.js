...
const DEBUG = require('debug'), debug = DEBUG('http_get:debug');
class HttpGet {
    execute(task) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let data = yield rq_1.default.get(task.check.url);
                if (data.status === 200) {
...
exports.default = new HttpGet();
//# sourceMappingURL=http_data.js.map